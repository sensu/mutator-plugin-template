...
## Overview
mutator-plugin-template is a template repository which wraps the [Sensu Plugins Go Library][2].
...
The {{ .Name }} is a [Sensu Mutator][9] that ...
...
[10]: https://docs.sensu.io/sensu-go/latest/reference/mutators/